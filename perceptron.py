...
# python imahadal-perceptron.py titanic-train.data titanic-train.label titanic-test.data titanic-test.label
# python imahadal-perceptron.py sample.data sample.label sample.data sample.label
# 
...
def train_perceptron(train_attr_data, train_label_data):
    ...
    while (count < max_iterations): 
        ...
        for index, row in train_data.iterrows():
            ...
            # Updating the weights vector and the bias 
            i = 0
            for att in row_t:
                if (att == "Survived"):
                    break
